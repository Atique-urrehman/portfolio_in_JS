...
import './Home.css'; // Include the specific CSS for this component
...
function Home() {
  ...
  const headingStyle = {
    fontSize: '2rem',
    marginBottom: '10px',
    color: 'var(--heading-color)', // Using the CSS variable for heading color
  };

  const paragraphStyle = {
    fontSize: '1.1rem',
    color: 'var(--text-color)', // Using the CSS variable for text color
    margin: '8px 0',
  };
